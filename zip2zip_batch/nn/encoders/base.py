...
from zip2zip_batch.config import EncoderConfigType, CompressionConfig
...
class BaseEncoder(nn.Module, ABC, Generic[EncoderConfigType]):
    ...
    def from_config(
        ...
        from zip2zip_batch.nn.encoders.attention import AttentionEncoder
        from zip2zip_batch.nn.encoders.transformer import TransformerEncoder

        from zip2zip_batch.nn.encoders.config import (
