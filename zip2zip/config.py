...
from zip2zip.utils.constants import CONFIG_NAME, MODEL_CARD_ZIP2ZIP_TEXT
...
@dataclass
class CheckpointDetails(PushToHubMixin):
    training_id: str = field(default=None, metadata={"help": "The training ID"})
    checkpoint_id: int = field(
        default=None, metadata={"help": "The checkpoint step ID"}
    )
    ...
    def save_pretrained(self, save_directory: str, **kwargs) -> None:
        ...
        output_path = os.path.join(save_directory, "zip2zip_checkpoint_details.json")
