...
class LZWCompressor:
    ...
    def decode(self, compressed_ids: List[int]) -> List[int]:
        """
    ...
    def batch_decode(self, compressed_ids: List[List[int]]) -> List[List[int]]:
        """
...
class CodebookManager:
    ...
    def update_codebooks(
        ...
        Returns:
            A tuple containing the new entries in the codebooks and the number of new entries.
        """
        ...
